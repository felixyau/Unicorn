          ...
          <main className="w-11/12">
            <section>
              ...
              <article className="rounded-xl bg-white p-8 shadow-md">
                <p className="mt-8">You are probably having Allergic rhinitis.</p>
                <p className="mt-8">
                ...
                <p className="mt-8">
                  ...
                  medication, such as a nasal spray containing corticosteroids.
                </p>
              </article>

              <button className="bg-white py-2 px-8 mt-8" style={{borderRadius:"50px"}}>Next</button>
            </section>
          </main>
